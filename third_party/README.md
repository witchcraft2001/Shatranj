...
| GFX320 / AFNT320 | `witchcraft2001/sprinter-libs` | Upstream sources and binary provenance are pinned; upstream does not currently contain a standalone license file | `GFX320.DLL` is copied to the Sprinter release; AFNT320 is verified but is not packaged in stage 0 |
